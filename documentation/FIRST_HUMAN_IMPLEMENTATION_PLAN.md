# First Human Implementation Plan
...
- Implemented on March 19, 2026:
  ...
  - Confirmed pathfinding remains isolated in `engine/world/aStarPathfinder.js`.
...
- Implemented on March 19, 2026:
  - Added framework-agnostic sub-tile A* module: `engine/world/subTilePathfinder.js`.
  ...
  - run sub-tile A* and output world-space waypoints
...
- Risk: Pathfinding cost spikes for distant clicks.
  - Mitigation: max node budget and optional distance cap for MVP.
- Risk: Collision jitter at tile corners.
  - Mitigation: waypoint center snapping + small arrival threshold + capped speed.
...
- Locked on March 19, 2026:
  ...
  - Pathfinding: Option A (4-dir A* + Manhattan heuristic).
  - Rigid body: Option A (Phaser Arcade Physics dynamic body + blocked-tile collision).
